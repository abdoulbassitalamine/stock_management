...
import '../../models/vendors_user_models.dart';
import '../auth/vendor_register_screen.dart';
import 'main_vendor_screen.dart';

class LandingScreen extends StatelessWidget {
  final CollectionReference _vendorsStream = FirebaseFirestore
      .instance
      .collection('vendors');
          ...
          return Center(child: Column(
            ...
            children: [
              ClipRRect(
                ...
                child: Image.network(vendorUserModel.storeImage.toString(),
                  width: 90,
                  fit: BoxFit.cover,),
              ),
              SizedBox(height: 15,),
